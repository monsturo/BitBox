...
public class Device2 extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (BluetoothDevice device : devices) {
            ...
            listItems.add(map);
            if(device.getAddress().equals("7C:66:9D:77:6E:BF")) {
                name = device.getName();
                address = device.getAddress();
                Intent intent = new Intent(Device2.this, PlayerTwo.class);
